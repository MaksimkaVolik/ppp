<div class="fullstory-width mx-auto card p-5">
   <h4 class="fw-bold">Обратная связь</h4>
   <div class="mt-3">
      <ul class="ui-form">
         [not-logged]
         <li class="form-group combo">
            <div class="combo_field"><input placeholder="Ваше имя" type="text" maxlength="35" name="name" id="name" class="form-control" required></div>
            <div class="combo_field"><input placeholder="Ваш E-mail" type="email" maxlength="35" name="email" id="email" class="form-control" required></div>
         </li>
         [/not-logged]
         <li class="form-group">
         ...
         [attachments]
         <li class="form-group">
            <label for="question_answer" class="form-label">Прикрепить файлы</label>
      ...
      <div class="form_submit">
         ...
         [/sec_code]
         <button class="btn btn-dark" type="submit" name="send_btn"><b>Отправить сообщение</b></button>
      </div>
   </div>
</div>